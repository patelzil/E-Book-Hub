...
- ### User Story: As a new user, I should be able to register by creating a username and a password so that the system can remember me and my data.
  <img src="./images/user_signup_diagram.png" alt="drawing" width="100%"/>
